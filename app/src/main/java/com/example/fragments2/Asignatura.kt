 ...
 * Use the [Asignatura.newInstance] factory method to
...
class Asignatura : Fragment() {
    ...
    private lateinit var nom_docente: EditText
    private lateinit var num_alum: EditText
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_asignatura, container, false)
        //Instanciamos los vies - Hacemos referencia
        nom_asignatura = view.findViewById(R.id.txt_asignaturaA)
        nom_docente = view.findViewById(R.id.txt_docente)
        num_alum = view.findViewById(R.id.txt_cant_alum)
        edt = view.findViewById(R.id.txtRegistrosA)
        botonRegistrar = view.findViewById(R.id.btn_registrarA)
    ...
    fun fnRegistrar(){
        var cadena = nom_asignatura.text.toString()+","+
                nom_docente.text.toString()+","+
                num_alum.text.toString()+","
        cadena+="\n"
//Manejo de archivos
